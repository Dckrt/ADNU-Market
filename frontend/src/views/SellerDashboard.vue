  ...
  <div class="dashboard-wrapper">
    <div class="container">
      ...
      <header class="dashboard-header">
        ...
        <button class="add-btn" @click="router.push('/add-product')">+ Add New Product</button>
      </header>
      ...
      <div v-else class="empty-state">
        ...
        <button @click="router.push('/add-product')" class="link-btn">Post your first item now</button>
      </div>
